...
Les skills du pipeline vivent dans `.claude/skills/` — Skill 1 : `read-the-market`, Skill 2 : `present-the-market` (chacune avec ses contrats dans `references/`). Schéma d'URL des runs : `[marché]/s[K]-[N]_[date]/`.
